...
//std::vector<BookStackElement>::iterator BookStackView::getSelectedElement() {
...
bool BookStackView::onStylusPress(int x, int y) {
    ...
    for(std::vector<BookStackElement>::iterator it = myItFirstRendering; it != myItLastRendering; ++it) {
