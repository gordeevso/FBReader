...
void BookshelfView::init()
{
    ...
    BookshelfModel::Instance().loadLibrarySortedByAuthor();
    BooksMap::const_iterator it = BookshelfModel::Instance().getLibrary().begin();
    BooksMap::const_iterator itEnd = BookshelfModel::Instance().getLibrary().end();
